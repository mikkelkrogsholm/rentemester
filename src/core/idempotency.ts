...
export const RETRY_OPERATION_NAMES = Object.freeze({
  ...
  naturalIdempotentCli: new Set(["import contacts", "bookkeeping-batch persist", "bookkeeping-batch dry-run", "bookkeeping-batch approve", "bookkeeping-batch apply", "dimensions budget-apply", "legacy-party-mapping apply", "legacy-party-mapping supersede", "vendor-identity-enrichment apply"]),
});
