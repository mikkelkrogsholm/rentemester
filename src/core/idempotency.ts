...
export const RETRY_CLASS_BY_OPERATION: Readonly<Record<string, RetryClass>> = Object.freeze({
  ...
  purchase_case_create: "key-idempotent", purchase_case_review: "key-idempotent", purchase_case_group_review: "key-idempotent",
...
export const RETRY_OPERATION_NAMES = Object.freeze({
  keyIdempotent: new Set(["journal_post", "journal_reverse", "expense_book", "payable_register", "payable_pay", "purchase_case_create", "purchase_case_review", "purchase_case_group_review", "bank_reconciliation_correction_apply", "direct_bank_purchase_payable_correction_apply"]),
