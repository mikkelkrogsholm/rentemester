...
export const RETRY_OPERATION_NAMES = Object.freeze({
  keyIdempotent: new Set(["journal_post", "journal_reverse", "expense_book", "payable_register", "payable_pay", "purchase_case_create", "purchase_case_review", "bank_reconciliation_correction_apply", "direct_bank_purchase_payable_correction_apply"]),
