...
export const MCP_TOOL_PERMISSIONS: Readonly<Record<string, RoutePermission>> = Object.freeze(Object.fromEntries([
  ...
  ..."workspace_party_search workspace_party_inspect corporate_record_list corporate_record_inspect corporate_record_download legacy_party_mapping_plan legacy_party_mapping_list".split(" ").map((n) => [n, "company.read"]),
  ...
  ..."workspace_party_create workspace_party_link_role corporate_record_ingest corporate_record_link corporate_record_enrich corporate_record_supersede legacy_party_mapping_apply legacy_party_mapping_supersede".split(" ").map((n) => [n, "company.master-data"]),
