...
export const MCP_TOOL_PERMISSIONS: Readonly<Record<string, RoutePermission>> = Object.freeze(Object.fromEntries([
  ...
  ..."bookkeeping_batch_approve purchase_case_review dimension_assignment_replace dimension_assignment_supersede dimension_budget_apply exception_resolve period_close period_close_review posting_rule_approve".split(" ").map((n) => [n, "company.review"]),
