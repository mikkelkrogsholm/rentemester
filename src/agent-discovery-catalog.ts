...
export const AGENT_WORKFLOWS: readonly AgentWorkflow[] = [
  ...
  ], unsupportedBoundaries:["Party resolution never changes linked/posted evidence bytes, VAT, or journals.", "Names or notes alone never prove identity. An ID-less non-EU source review additionally requires an explicit country, typed identity, verified source bytes and an approved canonical party name/alias.", "Source review does not infer jurisdiction from OSS/MOSS, relabel an internal voucher as a supplier invoice, or grant VAT treatment."] }),
