...
const capabilityTuples: CapabilityTuple[] = [
  ...
  ["document-intake", "Document and mail intake", "Store source documents and mail attachments for review.", "documents", ["ingest document", "mail intake", "review invoice extraction", "review incomplete purchase evidence", "record external payroll evidence"], ["bilag", "imap", "attachment", "incomplete invoice", "payroll evidence"], "company", ["document-mail-intake", "incomplete-purchase-evidence-review", "external-payroll-evidence-journal"]],
  ...
  ["supplier-purchases", "Supplier expenses and payables", "Book supplier invoices directly or through payable handling.", "purchases", ["book supplier invoice", "pay supplier invoice", "book expense", "adopt legacy payable"], ["vendor", "payable", "purchase VAT", "legacy backfill"], "company", ["supplier-expense-booking", "supplier-payable-handling", "direct-bank-purchase-payable-correction", "legacy-bank-payable-backfill"]],
